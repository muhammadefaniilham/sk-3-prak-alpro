...
int main(){
	...
	cout<<"WARUNG MAKAN SEDERHANA"<<endl;
	...
	if(jenis==1)
	{
		...
		{
			cout<<"Mendapatkan Potongan ongkir sebanyak 5000 dan diskon 15% "<<endl;
			tot=50000-5000/15;
			cout<<"Total biaya ongkir : "<<tot<<endl;
		}
		else if (total_hrg>150000)
		{
			cout<<"Mendapatkan potongan ongkir sebanyak 8000 dan diskon 35% "<<endl;
			tot=150000-5000/35;
		}
	
		cout<<"Total Harga makanannya : "<<total_hrg<<endl;
		cout<<"Total Biaya Ongkir  : "<<tot<<endl;
	}
	if(jenis==2)
	{
		cout<<"Ayam Goreng Rp.17000 "<<endl;
		cout<<"Pesan Berapa : ";
		cin>>jml;
		total_hrg=17000*jml;
		cout<<"Jarak Rumah (KM) : ";
	...
	if(jenis==3)
	{
		cout<<"Udang Goreng Rp.19000 "<<endl;
		cout<<"Pesan Berapa : ";
		cin>>jml;
		total_hrg=19000*jml;
		cout<<"Jarak Rumah (KM) : ";
		...
		if(jenis==4)
	{
		cout<<"Cumi Goreng Rp.20000 "<<endl;
		cout<<"Pesan Berapa : ";
		cin>>jml;
		total_hrg=20000*jml;
		cout<<"Jarak Rumah (KM) : ";
